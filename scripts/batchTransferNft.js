...
const ABI = require('../artifacts/contracts/NFTerc721.sol/NFTerc721.json');
...
async function main() {
  ...
  console.log("Bridging through FXPORTAL Approved and deposited");
  ...
  console.log("Your wallet  balance is:", balance.toString());
}
